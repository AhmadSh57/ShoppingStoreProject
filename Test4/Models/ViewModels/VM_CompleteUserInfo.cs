...
{
    public class VM_CompleteUserInfo
    {
        ...
        [Remote("CheckEmail", "Home", ErrorMessage = "این {0} از قبل وجود دارد")]
        ...
        [Remote("CheckMobile","Home",ErrorMessage ="این شماره موبایل در سایت وجود دارد")]
